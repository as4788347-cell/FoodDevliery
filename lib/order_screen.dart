...
class _OrdersScreenState extends State<OrdersScreen> {
  ...
  // Active Order UI card with progress indicators
        ...
        children: [
          Row(
            children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: const [
                    ...
                    Text(
                      '1x Spicy Salmon Roll, 1x Tuna Nigiri',
                      style: TextStyle(fontSize: 12, color: kGrey),
                      maxLines: 1,
                      overflow: TextOverflow.ellipsis,
                    ),
              ...
              const Text(
                'Total: ₹540',
                style: TextStyle(fontSize: 13, fontWeight: FontWeight.bold, color: kInk),
              ),
            ],
          ),
          const Padding(
            padding: EdgeInsets.symmetric(vertical: 14.0),
            child: Divider(color: kChipBorder, height: 1),
          ),
          ...
          Row(
            children: const [
              ...
              Text(
                'Preparing your food...',
                style: TextStyle(color: kGreen, fontWeight: FontWeight.bold, fontSize: 13),
              ),
              Spacer(),
              Text(
                '20 mins left',
                style: TextStyle(color: kGrey, fontSize: 12, fontWeight: FontWeight.w600),
              ),
            ],
          ),
          const SizedBox(height: 14),
          // Progress bar tracker dots
          Row(
            children: [
  ...
  // Card layout for Past Orders list
        ...
        children: [
          Row(
            ...
            children: [
              ...
              Text(
                order['price'],
                style: const TextStyle(fontSize: 13, fontWeight: FontWeight.bold, color: kInk),
              ),
            ],
          ),
          const Padding(
  ...
  Widget _bottomNavigationBar() {
    return BottomNavigationBar(
      ...
      onTap: (i) {
        if (i == 0) {
          Navigator.popUntil(context, (route) => route.isFirst); // Returns back to home page
        } else if (i == 1) {
