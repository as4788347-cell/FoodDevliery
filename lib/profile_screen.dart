      ...
      body: ListView(
        ...
        children: [
          ...
          _buildSettingsGroup('ACCOUNT SETTINGS', [
            _buildSettingsTile(Icons.location_on_outlined, 'Manage Addresses'),
            _buildSettingsTile(Icons.credit_card_outlined, 'Payment Methods'),
            _buildSettingsTile(Icons.notifications_none_outlined, 'Notification Settings'),
          ]),
          ...
          _buildSettingsGroup('SUPPORT & MORE', [
            ...
            _buildSettingsTile(Icons.info_outline, 'About Sora Food'),
          ]),
