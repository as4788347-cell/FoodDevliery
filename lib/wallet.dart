...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  final List<Map<String, String>> _savedCards = [
    {'bank': 'HDFC Bank Credit Card', 'card': 'VISA •••• 4321', 'holder': 'Abhishek Sharma'},
    {'bank': 'SBI Debit Card', 'card': 'MasterCard •••• 8765', 'holder': 'Abhishek Sharma'},
  ];
                              ...
                              ElevatedButton(
                                ...
                                onPressed: () {
                                  if (bankController.text.isNotEmpty && cardController.text.isNotEmpty) {
                                    setCardsState(() {
                                      _savedCards.add({'bank': bankController.text, 'card': '•••• ${cardController.text}', 'holder': 'Abhishek Sharma'});
                                    });
                                    Navigator.pop(context);
                                  }
                                },
